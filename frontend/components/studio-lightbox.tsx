...
export function StudioLightbox({
  ...
  const getPhotoSrc = (photo: any) => photo.src || photo.previewUrl || (photo.originalUrl?.startsWith('http') ? photo.originalUrl : null) || photo.url
