...
### Prompt 2: Trang Dashboard dành cho Studio (Quản lý dự án)

Trang này giúp Admin studio nhìn tổng quan tất cả các show chụp, trạng thái và dễ dàng tạo dự án mới.
